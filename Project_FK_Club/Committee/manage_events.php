...
foreach ($events_list as $e) {
    if (!empty($e['event_start_datetime']) && strtotime($e['event_start_datetime']) >= strtotime($today)) {
        $upcoming_events++;
    }
}
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($events_list as $event) { ?>
                                <tr data-event-id="<?php echo intval($event['event_id'] ?? 0); ?>">
                                    <td><?php echo $event['event_name']; ?></td>
                                    <td><?php echo $event['event_start_datetime']; ?></td>
                                    <td><?php echo $event['event_end_datetime']; ?></td>
                                    <td><?php echo $event['event_location']; ?></td>
                                    <td><?php echo $event['event_capacity']; ?></td>
                                    <td class="event-actions">
                                        <button class="action-btn btn-view" data-id="<?php echo intval($event['event_id'] ?? 0); ?>">
                                            <i class="fa-solid fa-eye"></i> View
                                        </button>
                                        <button class="action-btn btn-edit" data-id="<?php echo intval($event['event_id'] ?? 0); ?>">
                                            <i class="fa-solid fa-pen"></i> Edit
                                        </button>
                                        <button class="action-btn btn-delete" data-id="<?php echo intval($event['event_id'] ?? 0); ?>">
